            ...
            <div class="container ">
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <select class="custom-select" onchange="fillterCategory(this)">
                            <option selected>ประเภทโรงงาน</option>
                        ...
                        @foreach ($factory as $Factory)
                            <div class="col mt-4 ml-4">
                                <div class="card" style="width:20rem;">
                                    <img class="card-img-top" src='{{ asset("$Factory->img") }}' />
                                ...
                                <div class="modal-dialog  modal-lg " role="document">
                                    <div class="modal-content " style="width: auto;">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">{{ $Factory->fac_name }}
                                            </h5>
