...
@section('backend-content')
    ...
    fac_category.forEach(element =>
   { if (element == 'โรงปูนเปลี่ยนเป็นเชื้อเพลิง') {
            checkBox4.checked = true;
        } else if (element == 'โรงงานผลิตอุปกรณ์เกษตร') {
            checkBox3.checked = true;
        } else if (element == 'โรงงานผลิตอุปกรณ์ก่อสร้าง') {
            checkBox2.checked = true;
        } else if (element == 'โรงงานรีไซเคิล') {
